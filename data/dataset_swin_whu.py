...
class MyData(Dataset):
    def __init__(self):
        ...
        self.train_im_path1 = 'data/whu224_train/A'
        self.train_im_path2 = 'data/whu224_train/B'
        self.train_lb_path = 'data/whu224_train/label'
        self.train_im_num = 8874
...
class MyTestData(Dataset):
    def __init__(self):
        ...
        self.train_im_path1 = 'data/WHU-CD/whu224_test/A'
        self.train_im_path2 = 'data/WHU-CD/whu224_test/B'
        self.train_lb_path = 'data/WHU-CD/whu224_test/label'
        self.train_im_num = 986
        self.train_imgs1 = os.listdir(self.train_im_path1)
        self.train_imgs2 = os.listdir(self.train_im_path2)
        self.train_labels = os.listdir(self.train_lb_path)
