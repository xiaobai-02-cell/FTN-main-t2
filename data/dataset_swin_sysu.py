...
class MyData(Dataset):
    def __init__(self):
        ...
        self.train_im_path1 = 'data/SYSU256_train/A'
        self.train_im_path2 = 'data/SYSU256_train/B'
        self.train_lb_path = 'data/SYSU256_train/label'
        self.train_im_num = 16000
...
class MyTestData(Dataset):
    def __init__(self):
        ...
        self.train_im_path1 = 'data/sysu_test256/A256'
        self.train_im_path2 = 'data/sysu_test256/B256'
        self.train_lb_path = 'data/sysu_test256/label256'
        self.train_im_num = 4000
        self.train_imgs1 = os.listdir(self.train_im_path1)
        self.train_imgs2 = os.listdir(self.train_im_path2)
        self.train_labels = os.listdir(self.train_lb_path)
