...
class MyData(Dataset):
    def __init__(self):
        ...
        self.train_im_path1 = 'data/LEVIR-CD/levir224/train_224/A'
        self.train_im_path2 = 'data/LEVIR-CD/levir224/train_224/B'
        self.train_lb_path = 'data/LEVIR-CD/levir224/train_224/label'
        self.train_im_num = 12725
...
class MyTestData(Dataset):
    def __init__(self):
        ...
        self.train_im_path1 = 'data/LEVIR-CD/levir224/test_224/A'
        self.train_im_path2 = 'data/LEVIR-CD/levir224/test_224/B'
        self.train_lb_path = 'data/LEVIR-CD/levir224/test_224/label'
        self.train_im_num = 3200
        self.train_imgs1 = os.listdir(self.train_im_path1)
        self.train_imgs2 = os.listdir(self.train_im_path2)
        self.train_labels = os.listdir(self.train_lb_path)
